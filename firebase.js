// Firebase + Cloudinary Config (public)
...
export const ADMIN_UID = "31ZskJ12hdNhy5D5lwP6dPB5Kw92";

// Cloudinary unsigned upload settings (public). Consider signed uploads for stronger security.
