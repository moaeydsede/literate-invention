...
v5:
- Reports Pro (date range, cashbox, monthly, top accounts) + Print/PDF
- Loading fixes (skeleton + timeout + fallback)


v6:
- Cache-bust to fix Loading/Syntax caching
- Reports Pro + Charts (Canvas)


v7:
- Ultra-safe loader: dynamic import with catch (shows error UI instead of blank loading)
- Auto SW unregister + cache clear button
- Strong cache-bust (app.js?v=7)
